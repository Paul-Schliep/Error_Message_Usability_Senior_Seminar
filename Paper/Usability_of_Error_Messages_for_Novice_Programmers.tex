...
There is currently little research done on the usability of error messages.
However, with the larger interest in the field of computer science and the growth in HCI studies, error message research, specifically for introductory programmers, has grown.
Marceau et al created a series of recommendations that they plan on implementing in the future, which, based on their research, shows promise toward helping students improve their debugging skills ~\cite{Marceau:2011:MYL:2048237.2048241}.
Also, while Denny et al enhanced syntax error messages was ineffective, they hope to figure out why and improve upon them in the future.
